          ...
          <div className="">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 px-4">
              {data.map((packageData, index) => (
                <div key={index} className="bg-[#A020F0] rounded-lg overflow-hidden py-4 px-2 text-center text-white space-y-8">
                  {/* card Header */}
                  <div>
                    <h2 className="font-bold text-base uppercase">{packageData.packageName}</h2>
                  </div>
                  <hr />
                  {/* card Body */}
                  <div className="space-y-4">
                    {/* Up to */}
                    <div>
                      <h3 className="font-medium text-base">Up to {packageData.initialReward}BTCA</h3>
                      <p className="font-medium text-base">{packageData.description}</p>
                    </div>
                    <hr />
                    {/* Mining reward */}
                    <div>
                      <h3 className="font-medium text-base">{packageData.monthlyReward}BTCA</h3>
                      <p className="font-medium text-base">Mining Reward per month</p>
                    </div>
                    <hr />
                    {/* Expected Mining */}
                    <div>
                      <h3 className="font-medium text-base">{packageData.yearlyReward}BTCA</h3>
                      <p className="font-medium text-base">Expected Mining</p>
                    </div>
                    <hr />
                    {/* Validity */}
                    <div>
                      <h3 className="font-medium text-base">{packageData.duration} Year</h3>
                      <p className="font-medium text-base">Validity</p>
                    </div>
                    <hr />
                    {/* Unfreezing Term */}
                    <div>
                      <h3 className="font-medium text-base">${packageData.price}</h3>
