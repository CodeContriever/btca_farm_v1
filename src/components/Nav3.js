      ...
      <div class="flex flex-wrap justify-between items-center gap-x-1 gap-y-4">
        ...
        <div class="flex items-center lg:order-2">
          ...
          <button
            ...
            class="hidden lg:flex p-2 text-gray-500 rounded-lg hover:text-gray-900 hover:bg-gray-100 dark:text-gray-400 dark:hover:text-white dark:hover:bg-gray-700 focus:ring-4 focus:ring-gray-300 dark:focus:ring-gray-600"
          >
            <span class="sr-only">View notifications</span>
            {/* <!-- Icon --> */}
            <svg
