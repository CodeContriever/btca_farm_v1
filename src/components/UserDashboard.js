...
import MiningStatus from './userDB/MiningStatus';
import IndicatorGauge from './userDB/indicator/IndicatorGuage';
import IndicatorLegend from './userDB/indicator/IndicatorLegend';
import PriceSection from './userDB/PriceSection';
import FarmPackages from './userDB/packages/FarmPackages';
import CardLoad from './userDB/loads/CardLoad';
import TransactionHistory from './userDB/transactions/TransactionHistory';
import SpeedCard from './userDB/farmSpeed/SpeedCard';
import FarmSpeed from './userDB/farmSpeed/FarmSpeed';
            ...
            <div className="border-2 border-dashed rounded-lg border-gray-300 dark:border-gray-600 mb-8">
              <div className="box-border border-2 border-gray-300 rounded-md p-9 flex flex-col lg:flex-row items-center justify-around">
                ...
                <div className="box-border m-0">
                  <IndicatorLegend color="green-500" label="Green" />
                  <IndicatorLegend color="yellow-400" label="Yellow" />
                  <IndicatorLegend color="red-500" label="Red" />
                </div>
              </div>
            </div>
