...
const License = () => {
  const [activeButton, setActiveButton] = useState("licenseKey");

  const [transactionData, setTransactionData] = useState([])

  const handleLicenseKeyClick = async (buttonName) => {
              ...
              >
                ...
                >
                  <button
                    ...
                    ${activeButton === 'licenseKey' ? 'text-blue-600' : 'text-gray-600'}`}
                    onClick={() => handleLicenseKeyClick('licenseKey')}
                  >
                    License keys
                  </button>
                  ...
                  <button
                    className={`box-border p-3 md:p-6 transition-colors whitespace-nowrap text-base md:text-lg font-medium leading-6 cursor-pointer relative text-center 
                    ${activeButton === 'activationHistory' ? 'text-blue-600' : 'text-gray-600'}`}
                    onClick={() => handleHistoryClick('activationHistory')}
                  >
                    Activation History
                  </button>
                ...
                <div className="mb-4">
                  ...
                  <p
                    className="box-border mb-0 mt-0 text-gray-800  text-base font-medium font-inter leading-6"
                  >
                    On this page you can see the activation history of your keys as well as information about which max load was added to your farm
                  </p>

                </div>

                {/* License keys content */}
                {activeButton === 'licenseKey' && (
                            ...
                            {transactionData.length > 0 ? (
                              ...
                              >
                                ...
                                >
                                  ...
                                  >
                                    You do not have any License keys
                                  </p>
                ...
                {/* Actvation History content */}
                {activeButton === 'activationHistory' && (
                              ...
                              >
                                ...
                                >
                                  ...
                                  <p
                                    className="box-border mb-0 text-gray-500 text-base font-normal leading-5 mt-2"
                                  >
                                    You do not have any Activation history
                                  </p>
